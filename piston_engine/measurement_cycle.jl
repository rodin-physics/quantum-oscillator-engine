...
for p in params
    ...
    if !isfile("data/piston_engine/measurement_cycle/Measurement_cycle_τ$(τ_stroke)_σ$(σ).jld2")


        # Cold, piston close
        function cycle(ρ0)
            # Measure the gas
            close_hot = diagm(diag(ρ0))
            # Retract the piston
        ...
        save_object(
            "data/piston_engine/measurement_cycle/Measurement_cycle_τ$(τ_stroke)_σ$(σ).jld2",
            (res, τ_stroke, σ),
        )
...
set_theme!(CF_theme)
data = [
    "data/piston_engine/measurement_cycle/Measurement_cycle_τ5_σ0.5.jld2",
    "data/piston_engine/measurement_cycle/Measurement_cycle_τ5_σ2.jld2",
    "data/piston_engine/measurement_cycle/Measurement_cycle_τ10_σ0.5.jld2",
    "data/piston_engine/measurement_cycle/Measurement_cycle_τ10_σ2.jld2",
]
...
fig
save("Measurement_Engine_Operation.pdf", fig)
